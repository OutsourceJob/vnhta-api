...
export class SheetService {
  ...
  async queryRawFile() {
    const query = `
      ...
      -- COST BENEFIT
      cost_benefit.pathology_id AS cost_benefit_pathology_id, pathology.name AS cost_benefit_pathology_name,
      ...
      cost_benefit.data_collecting_method_id_array AS cost_benefit_data_collecting_method_id_array,
      ...
      cost_benefit.real_world_sample_size AS cost_benefit_real_world_sample_size,
